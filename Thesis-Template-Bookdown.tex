...
\addcontentsline{toc}{section}{数据模拟}
...
\addcontentsline{toc}{section}{HMC 算法}
...
{\centering \subfloat[编译\label{fig:compiling-sampling1}]{\includegraphics[width=0.7\linewidth]{figures/compiling} }\subfloat[采样\label{fig:compiling-sampling2}]{\includegraphics[width=0.7\linewidth]{figures/sampling} }
